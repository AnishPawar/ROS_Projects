...
(cl:defmethod cl:initialize-instance :after ((m <HardwareStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HardwareStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name custom_msgs-msg:<HardwareStatus> is deprecated: use custom_msgs-msg:HardwareStatus instead.")))
...
(cl:defmethod motor_stat-val ((m <HardwareStatus>))
