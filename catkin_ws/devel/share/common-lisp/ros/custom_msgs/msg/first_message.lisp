...
;//! \htmlinclude first_message.msg.html

(cl:defclass <first_message> (roslisp-msg-protocol:ros-message)
  ((temprature
    :reader temprature
    :initarg :temprature
    :type cl:integer
...
(cl:defclass first_message (<first_message>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <first_message>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'first_message)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name custom_msgs-msg:<first_message> is deprecated: use custom_msgs-msg:first_message instead.")))

(cl:ensure-generic-function 'temprature-val :lambda-list '(m))
(cl:defmethod temprature-val ((m <first_message>))
...
(cl:defmethod motor_stat-val ((m <first_message>))
...
(cl:defmethod debug_message-val ((m <first_message>))
  ...
  (debug_message m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <first_message>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <first_message>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<first_message>)))
  "Returns string type for a message object of type '<first_message>"
  "custom_msgs/first_message")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'first_message)))
  "Returns string type for a message object of type 'first_message"
  "custom_msgs/first_message")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<first_message>)))
  "Returns md5sum for a message object of type '<first_message>"
  "f537432f8f1c04503d008c5851a94e1d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'first_message)))
  "Returns md5sum for a message object of type 'first_message"
  "f537432f8f1c04503d008c5851a94e1d")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<first_message>)))
  "Returns full string definition for message of type '<first_message>"
  (cl:format cl:nil "int64 temprature~%bool motor_stat~%string debug_message~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'first_message)))
  "Returns full string definition for message of type 'first_message"
  (cl:format cl:nil "int64 temprature~%bool motor_stat~%string debug_message~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <first_message>))
  (cl:+ 0
     8
     1
     4 (cl:length (cl:slot-value msg 'debug_message))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <first_message>))
  "Converts a ROS message object to a list"
  (cl:list 'first_message
