...
(cl:defmethod cl:initialize-instance :after ((m <CircleArea-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CircleArea-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Robot_Messages-srv:<CircleArea-request> is deprecated: use Robot_Messages-srv:CircleArea-request instead.")))

(cl:ensure-generic-function 'radius-val :lambda-list '(m))
(cl:defmethod radius-val ((m <CircleArea-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Robot_Messages-srv:radius-val is deprecated.  Use Robot_Messages-srv:radius instead.")
  (radius m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CircleArea-request>)))
  ...
  "Robot_Messages/CircleAreaRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CircleArea-request)))
  "Returns string type for a service object of type 'CircleArea-request"
  "Robot_Messages/CircleAreaRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <CircleArea-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CircleArea-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Robot_Messages-srv:<CircleArea-response> is deprecated: use Robot_Messages-srv:CircleArea-response instead.")))

(cl:ensure-generic-function 'area-val :lambda-list '(m))
(cl:defmethod area-val ((m <CircleArea-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Robot_Messages-srv:area-val is deprecated.  Use Robot_Messages-srv:area instead.")
  (area m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CircleArea-response>)))
  ...
  "Robot_Messages/CircleAreaResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CircleArea-response)))
  "Returns string type for a service object of type 'CircleArea-response"
  "Robot_Messages/CircleAreaResponse")
